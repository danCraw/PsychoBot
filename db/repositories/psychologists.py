...
class PsychologistRepository(BaseRepository):
    ...
    async def psychologists_list(self, specializations_table: Specialization, psychologists_specializations_table: Psychologist_specialization) -> list[PsychologistOut]:
